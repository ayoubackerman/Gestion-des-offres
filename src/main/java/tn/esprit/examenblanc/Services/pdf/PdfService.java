package tn.esprit.examenblanc.Services.pdf;
...
public class PdfService {
    ...
    public ByteArrayInputStream devisToPdf(List<Devi> devisList) {
        ...
        try {
            ...
            Image logo = Image.getInstance("C:\\Users\\MediaCenter Zaghouan\\Downloads\\Logo_ESPRIT_Ariana.jpg"); // Replace with your logo path
